...
enum KeyboardShortcutSettings {
    ...
    enum Action: String, CaseIterable, Identifiable {
        ...
        var label: String {
            ...
            case .makeSplitNarrower: return String(localized: "shortcut.makeSplitNarrower.label", defaultValue: "Make Active Split Narrower")
        ...
        var defaultShortcut: StoredShortcut {
            ...
            case .makeSplitWider: return StoredShortcut(key: "→", command: true, shift: false, option: false, control: true)
            case .makeSplitNarrower: return StoredShortcut(key: "←", command: true, shift: false, option: false, control: true)
            case .splitBrowserRight:
